...
save.addEventListener("click",async function(){
    ...
    if(titleContent=="" && descriptionContent==""){
        ...
        noteObject.idUser=1
        const endPointGetTag="https://betancurgiraldo-f62ef3back-production.up.railway.app/tag";
        let tagSearch;
        if(tag.value!=""){
        ...
        const endPointCreateNote="https://betancurgiraldo-f62ef3back-production.up.railway.app/note";
...
async function setNotes(){
    const endPointGetNotes="https://betancurgiraldo-f62ef3back-production.up.railway.app/note";
    const notes = await searchAll(endPointGetNotes)
    notes.forEach(async note =>  {
        let textTag=""
        if(note.archived==false){
            if(note.idTag!=null){
                const endPointGetTag="https://betancurgiraldo-f62ef3back-production.up.railway.app/tag/"+note.idTag;
...
deleteNote.addEventListener("click",async ()=>{
    const endPointDeleteNote="https://betancurgiraldo-f62ef3back-production.up.railway.app/note/"+selectedNote.id;
...
archiveNote.addEventListener("click",async ()=>{
    const endPointUpdateNote="https://betancurgiraldo-f62ef3back-production.up.railway.app/note";
...
async function verifyUpdate(){
    const endPointGetNote="https://betancurgiraldo-f62ef3back-production.up.railway.app/note/"+selectedNote.id;
    ...
    if(data.idTag!=undefined){
        const endPointGetTag="https://betancurgiraldo-f62ef3back-production.up.railway.app/tag/"+data.idTag;
        const dataTag = await searchAll(endPointGetTag)
...
async function verifyTag(tag){
    ...
    if(find){
        ...
        const endPointPostTag="https://betancurgiraldo-f62ef3back-production.up.railway.app/tag";
...
deleteNoteA.addEventListener("click",async ()=>{
    const endPointDeleteNote="https://betancurgiraldo-f62ef3back-production.up.railway.app/note/"+selectedNoteA.id;
    await deleteId(endPointDeleteNote);
    simulateClick(archivedNotes);
})
...
async function verifyUpdateA(){
    const endPointGetNote="https://betancurgiraldo-f62ef3back-production.up.railway.app/note/"+selectedNoteA.id;
    let data = await searchAll(endPointGetNote)
...
async function setTags(){
    const endPointGetTags="https://betancurgiraldo-f62ef3back-production.up.railway.app/tag";
...
selectCategory.addEventListener("change",async ()=>{
    ...
    if(optionSelectedId=="None"){
        ...
        packCategory.innerHTML=""
        endPointGetNote="https://betancurgiraldo-f62ef3back-production.up.railway.app/note"
